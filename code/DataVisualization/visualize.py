...
class Visualize:
    ...
    def generate_all_visualizations_over_runs(self):
        ...
        for simulation in simulations:  # For each simulation
            ...
            self.visualizer.visualize_over_different_runs(simulation, 'road', 'car', 'flow', False)
            self.visualizer.visualize_over_different_runs(simulation, 'road', 'bike', 'flow', False)
            self.visualizer.visualize_over_different_runs(simulation, 'road', 'agent', 'flow', False)
            self.visualizer.visualize_over_different_runs(simulation, 'road', 'car', 'density', False)
            self.visualizer.visualize_over_different_runs(simulation, 'road', 'bike', 'density', False)
            self.visualizer.visualize_over_different_runs(simulation, 'road', 'agent', 'density', False)
