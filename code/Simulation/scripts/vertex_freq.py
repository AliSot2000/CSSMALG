...
"""
This file was used when we had an issue with the agents not reaching their destination. The assumption at the  time was 
that the agents were not reaching their destination because of a bottle-neck in the map. This file plots the frequency 
of the vertices in the based on the number of times a vertex was on a path from a to be of a given agent. 

It was useful but is no longer needed. It's here for the sake of completeness and in case of future 
need.
"""
