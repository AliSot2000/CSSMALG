...
class AgentGenerator
{
            ...
            for ($repetitions = 0; $repetitions < 10; $repetitions++) {
                ...
                foreach ($agentAmount as $hour => $amount) {
                    ...
                    for ($i = 0; $i < 60; $i++) {
                        ...
                        // create car agents
                        for ($j = 0; $j < round($amountPerMinute * (1 - $bikePercentage)); $j++) {
                        ...
                        // create cyclists
                        for ($j = 0; $j < round($amountPerMinute * $bikePercentage); $j++) {
                            // pseudo random length in m
                            $length = rand(3, 5) / 2;
                            // pseudo random max velocity in km/h
    ...
    private function calculateAgentAmount(): array {
        ...
        $agentDistribution = array(0.05, 0.05, 0.06, 0.75, 0.1, 0.25, 0.4, 0.65, 0.55, 0.45, 0.4, 0.5, 0.5, 0.4, 0.4, 0.55, 0.8, 1, 0.8, 0.5, 0.3, 0.1, 0.075, 0.05);
